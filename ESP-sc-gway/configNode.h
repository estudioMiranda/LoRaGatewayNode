...
#define _DESCRIPTION "ESP32 Gateway ArduinoES"			// Name of the gateway
#define _EMAIL "studiomiranda@hotmail.com"		// Owner
#define _PLATFORM "ESP32 "
#define _LAT 43.3730677
#define _LON -8.4262774
#define _ALT 17								// Altitude
